...
class DrugDataset(utils.Dataset):
    ...
    def load_shapes(self, count, img_floder, mask_floder, imglist, dataset_root_path):
        ...
        self.add_class("shapes", 1, "antelope")  # 黑色素瘤
        self.add_class("shapes", 2, "Asian Elephant")  # 黑色素瘤
    ...
    def load_mask(self, image_id):
        ...
        for i in range(len(labels)):
            if labels[i].find("antelope") != -1:
                # print "box"
                labels_form.append("antelope")
            elif labels[i].find("Asian Elephant") != -1:
                # print "box"  
                labels_form.append("Asian Elephant")
...
def predict(image_path):
    ...
    class_names = ['BG', 'antelope','Asian Elephant']
    # IMAGE_DIR = os.path.join(ROOT_DIR, "images")
    # Load a random image from the images folder
    # file_names = r'C:\Users\hedeqing\Desktop\SchoolWork\mask_rcnn\images\antelope_0.jpg' # next(os.walk(IMAGE_DIR))[2]
...
if __name__ == "__main__":
     ...
     IMAGE_DIR = os.path.join(ROOT_DIR, "images")
     file_names = next(os.walk(IMAGE_DIR))[2]
     file_path = os.path.join(IMAGE_DIR, random.choice(file_names))
     predict(file_path)
